...
<%@page import="com.shopping.cart.dao.OrderDao"%>
<%@page import="com.shopping.cart.model.Order"%>
...
if (us != null) {
	...
	OrderDao od = new OrderDao(DbConn.getConnection());
	orders = od.userOrders(us.getId());
} else {
